...
import { Box, Text, Icon, Button, Card, CardBody, Divider, IconButton, Tooltip, useClipboard } from '@chakra-ui/react';
...
const TxidPage = ({ txHash, explorerUrl }: { txHash: string; explorerUrl: string }) => {
  ...
  return (
    <Card border="1px solid white" borderRadius="md" p={8} textAlign="center" backgroundColor="gray.900" color="white">
      <CardBody>
