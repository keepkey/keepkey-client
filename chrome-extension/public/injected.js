    ...
    features = {
      ...
      'solana:signIn': {
        ...
        signIn: async (...a) => {
          ...
          for (let n of a) {
            if (this.#e.length === 0) {
              let m = this.#t || (await this.#n('solana_connect', []));
              m && this.#a(m);
            }
            let h = this.#e[0];
          ...
          let s = ++b,
            ...
            c = r => {
              ...
              r.source === window &&
                ...
                ((w = r.data) == null ? void 0 : w.requestId) === s &&
                (clearTimeout(e),
      ...
      let t = new B(),
        s = {
          ...
          sendAsync: (e, c, r) => {
            ...
            m(e.method, e.params || c, o, (u, w) => {
              u ? g(u) : g(null, { id: e.id, jsonrpc: '2.0', result: w });
            });
          },
          on: (e, c) => (t.on(e, c), s),
          off: (e, c) => (t.off(e, c), s),
    ...
    async function j() {
      ...
      let t = A('ethereum'),
        ...
        c = (r, g, { force: u = !1 } = {}) => {
          if (y[r] && !u) {
            console.warn(
              o,
              `window.${r} already present \u2014 yielding to it (EIP-6963 still announced for discovery)`,
            );
            return;
          }
          try {
            ...
            (console.error(o, `Failed to mount window.${r}:`, K), (p.lastError = `Failed to mount ${r}`));
          }
        };
      (c('ethereum', t),
        c('xfi', s),
      ...
      (window.addEventListener('message', r => {
        ...
        (((g = r.data) == null ? void 0 : g.type) === 'CHAIN_CHANGED' &&
          ...
          ((w = r.data) == null ? void 0 : w.type) === 'ACCOUNTS_CHANGED' &&
